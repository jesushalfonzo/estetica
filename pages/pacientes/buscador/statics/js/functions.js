$(document).ready(function()
{
    ...
    */
    ...
    $("input[name=autocomplete]").delayPasteKeyUp(function()
    {
        $.ajax({
        	type: "POST",
            url: "http://localhost/ESTETICA/pages/pacientes/buscador/app/instancias/autocomplete.php",
            ...
            success: function(data)
            {
            	if(data)
            	{
                 ...
                 if(json.res == 'full')
                 {
                     ...
                     {
                        html+='<a href="#" onclick="direccionar('+json.data[datos].id+')" class="list-group-item">';
